...
public class ImagePickRecyclerView extends RecyclerView {
    ...
    private ImagePickRecyclerViewAdapter.OnDeleteInnerClickListener onDeleteInnerClickListener;
    ...
    private void init(Context context) {
        ...
        imagePickRecyclerViewAdapter.setOnDeleteInnerClickListener(new ImagePickRecyclerViewAdapter.OnDeleteInnerClickListener() {
            ...
            public void onDeleteInnerClick(View view, int pos) {
                ...
                if (onDeleteInnerClickListener != null) {
                    onDeleteInnerClickListener.onDeleteInnerClick(view,pos);
                }
            }
        });
...
*/
   ...
   public void  setOnDeleteInnerClickListener(ImagePickRecyclerViewAdapter.OnDeleteInnerClickListener onDeleteInnerClickListener) {
